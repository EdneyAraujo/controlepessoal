            ...
            <div class="row clearfix">
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Pessoal <small>Documentos Pessoais</small>
                            </h2>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Comprovantes <small>Comprovvantes de pagamentos</small>
                            </h2>
                            <ul class="header-dropdown m-r--5">
                                <li>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                Financeiros <small>Documentos Financeiros, Holerites, ferias e contratos</small>
                            </h2>
